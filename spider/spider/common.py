...
default_headers = OrderedDict({k.title(): v for k, v in {
    ...
    'SEC-FETCH-SITE': 'cross-site', 'SEC-FETCH-USER': '?1', 'SEC-ORIGIN-POLICY': '0',
    'UPGRADE-INSECURE-REQUESTS': '1', 'VIEWPORT-WIDTH': '1920'}.items()})
